...
| 특징 | 설명 |
|------|------|
| **바로 사용 가능** | 41개 에이전트, 55개 스킬, 22개 가이드, 18개 규칙, 2개 훅, 4개 컨텍스트, 온톨로지 그래프 - 즉시 사용 가능 |
...
| **개발** | 5 | dev-review, dev-refactor, create-agent, intent-detection, web-design-guidelines |
...
| **품질 & 워크플로우** | 2 | multi-model-verification, structured-dev-cycle |
...
├── .claude/
│   ├── agents/            # 에이전트 정의 (41개 플랫 .md 파일)
│   ├── skills/            # 스킬 모듈 (55개 디렉토리)
