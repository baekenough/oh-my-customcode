...
## 격식 수준 (R000 Honorific Level)

- 기본 격식 수준: **합쇼체** (formal polite, "-습니다" / "-합니다" / "-십시오")
- 금지: 반말 ("확인", "이상함"), 해요체 ("확인해요"), 명사 종결 ("확인", "수정")
- 강제 위치: 모든 사용자 응답 (간단한 진단/회고 응답 포함)
- 예외: 코드 주석, 식별자, 명령어, 기술 용어는 원문 유지
