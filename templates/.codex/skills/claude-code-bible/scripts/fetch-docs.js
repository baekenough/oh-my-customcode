 ...
 * fetch-docs.js
 *
 * Fetches Claude Code official documentation from code.codex.com
 ...
 *   --output <dir>   Output directory (default: ~/.codex/references/claude-code/)
 */
...
// Configuration
const LLMS_TXT_URL = 'https://code.codex.com/docs/llms.txt';
const DEFAULT_OUTPUT_DIR = path.join(homedir(), '.codex', 'references', 'claude-code');
...
function extractDocUrls(llmsTxtContent) {
  ...
  const markdownLinkRegex = /\(https?:\/\/code\.codex\.com\/docs\/[^)]+\)/g;
  const bareLinkRegex = /^https?:\/\/code\.codex\.com\/docs\/\S+/gm;
