...
Fetch the latest documentation from code.codex.com.

**What it does:**
- Fetches `https://code.codex.com/docs/llms.txt`
...
3. **Agent files** should NOT contain:
   - Detailed skill instructions (belongs in .codex/skills/)
   - Reference documentation (belongs in guides/)
   - Implementation scripts (belongs in .codex/skills/{name}/scripts/)
...
1. Read official specs from `~/.codex/references/claude-code/`
2. Parse all agents in `.codex/agents/*.md`
3. Parse all skills in `.codex/skills/*/SKILL.md`
